class router_env extends uvm_env;
    ...
    //0-north 1-west 2-south 3-east 4-local 5-bound
    cibd_agent i_agt[6];
    cibd_agent o_agt[6];
    router_model mdl;
    router_scoreboard sb;

    uvm_tlm_analysis_fifo #(cibd_transaction) drv_mdl_fifo[6]; //TLM
    uvm_tlm_analysis_fifo #(cibd_transaction) mdl_sb_fifo[6]; //TLM
    uvm_tlm_analysis_fifo #(cibd_transaction) mon_sb_fifo[6]; //TLM
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        i_agt[5] = cibd_agent::type_id::create("i_agt[5]",this);
        ...
        o_agt[5] = cibd_agent::type_id::create("o_agt[5]",this);
        ...
        `uvm_info("router_env","mdl is built",UVM_LOW)
        `uvm_info("router_env","sb is built",UVM_LOW)
        ...
        drv_mdl_fifo[5] = new("drv_mdl_fifo[5]",this); //TLM
        ...
        mdl_sb_fifo[5] = new("mdl_sb_fifo[5]",this); //TLM
        ...
        mon_sb_fifo[5] = new("mon_sb_fifo[5]",this); //TLM
