class router_scoreboard extends uvm_scoreboard;
    ...
    cibd_transaction expect_queue_b[$];
    ...
    cibd_transaction actual_queue_b[$];

    uvm_blocking_get_port #(cibd_transaction) exp_bp[6]; //TLM from model
    uvm_blocking_get_port #(cibd_transaction) act_bp[6]; //TLM from monitor
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        exp_bp[5] = new("exp_bp[5]",this); //TLM 
        ...
        act_bp[5] = new("act_bp[5]",this); //TLM
    endfunction

    virtual task main_phase(uvm_phase phase);
        cibd_transaction get_expect[6],get_actual[6];
        bit result;
        ...
        fork
            ...
            begin
                ...
                expect_queue_n.push_back(get_expect[0]);
            end
            ...
            begin
                ...
                expect_queue_w.push_back(get_expect[1]);
            end
            ...
            begin
                ...
                expect_queue_s.push_back(get_expect[2]);
            end
            ...
            begin
                ...
                expect_queue_e.push_back(get_expect[3]);
            end
            ...
            while(1)
            begin
                exp_bp[5].get(get_expect[5]);
                `uvm_info("expect_b",{"\n",get_expect[5].sprint()},UVM_LOW)
                expect_queue_b.push_back(get_expect[5]);
            end
            ...
            begin
                ...
                actual_queue_n.push_back(get_actual[0]);
            end
            ...
            begin
                ...
                actual_queue_w.push_back(get_actual[1]);
            end
            ...
            begin
                ...
                actual_queue_s.push_back(get_actual[2]);
            end
            ...
            begin
                ...
                actual_queue_e.push_back(get_actual[3]);
            end
            ...
            while(1)
            begin
                act_bp[5].get(get_actual[5]);
                `uvm_info("actual_b",{"\n",get_actual[5].sprint()},UVM_LOW)
                actual_queue_b.push_back(get_actual[5]);
            end
        join
    endtask
        ...
        if(actual_queue_w.size() == expect_queue_w.size()) begin
            ...
            begin
                ...
                for(i = 0; i < expect_queue_w.size(); i++) begin
                    if(temp_trans.compare_payload(expect_queue_w[i])) begin
                        flag = 1;
                        break;
                    end
                end
        ...
        if(actual_queue_e.size() == expect_queue_e.size()) begin
            ...
            begin
                ...
                for(i = 0; i < expect_queue_e.size(); i++) begin
                    if(temp_trans.compare_payload(expect_queue_e[i])) begin
                        flag = 1;
                        break;
                    end
                end
        ...
        if(actual_queue_n.size() == expect_queue_n.size()) begin
            ...
            begin
                ...
                for(i = 0; i < expect_queue_n.size(); i++) begin
                    if(temp_trans.compare_payload(expect_queue_n[i])) begin
                        flag = 1;
                        break;
                    end
                end
        ...
        if(actual_queue_s.size() == expect_queue_s.size()) begin
            ...
            begin
                ...
                for(i = 0; i < expect_queue_s.size(); i++) begin
                    if(temp_trans.compare_payload(expect_queue_s[i])) begin
                        flag = 1;
                        break;
                    end
                end
        ...
        if(actual_queue_l.size() == expect_queue_l.size()) begin
            ...
            begin
                ...
                for(i = 0; i < expect_queue_l.size(); i++) begin
                    if(temp_trans.compare_payload(expect_queue_l[i])) begin
                        flag = 1;
                        break;
                    end
                end
            ...
            `uvm_error("router_scoreboard","size not equal")
            `uvm_error("router_scoreboard",$sformatf("expect transactions:%0d but actual transactions:%0d",expect_queue_l.size(),actual_queue_l.size()))
        end

        `uvm_info("router_scoreboard","\n\n\nstarting bound port verification",UVM_LOW)
        if(actual_queue_b.size() == expect_queue_b.size()) begin
            while(actual_queue_b.size() > 0)
            begin
                temp_trans = actual_queue_b.pop_front();
                for(i = 0; i < expect_queue_b.size(); i++) begin
                    if(temp_trans.compare_payload(expect_queue_b[i])) begin
                        flag = 1;
                        break;
                    end
                end
            ...
            `uvm_error("router_scoreboard","size not equal")
            `uvm_error("router_scoreboard",$sformatf("expect transactions:%0d but actual transactions:%0d",expect_queue_b.size(),actual_queue_b.size()))
        end
